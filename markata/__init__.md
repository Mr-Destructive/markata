...
long_description: Markata is a tool for handling directories of markdown. Markata
  is a tool for handling directories of markdown. None None ???  ???  None None ???  ???  None
  None ???  ???  None None ???  ???  None None ???  ???  None None ???  ???  None
  None ???  ???
now: 2022-05-16 15:15:57.706809
path: __init__.md
